...
async function handleTracking(req, resolvedParams, payload = null) {
...
export async function GET(req, { params }) {
  try {
    ...
    const payload = {
      pagePath: searchParams.get("pagePath") || searchParams.get("path") || "/",
      pageTitle: searchParams.get("pageTitle") || "",
      userAgent: req.headers.get("user-agent") || "",
      referer: searchParams.get("referer") || req.headers.get("referer") || "",
    };

    return await handleTracking(req, resolvedParams, payload);
  } catch (error) {
    console.error("Page view tracking GET error:", error);
    return new Response(
      JSON.stringify({
        success: false,
...
export async function POST(req, { params }) {
  try {
    ...
    return await handleTracking(req, resolvedParams, body);
  } catch (error) {
