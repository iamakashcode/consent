...
function showPreferencesModal(bannerEl){
  ...
  modal.innerHTML=
    ...
    '</div>'+
    '<p style="text-align:center;font-size:16px;color:#212121;line-height:1.5;padding-top:16px;margin:0px">Powered by <span style="font-weight:600;">Cookie Access</span></p></div>';
