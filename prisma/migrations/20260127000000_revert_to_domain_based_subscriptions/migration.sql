-- Migration: Revert to Domain-Based Subscriptions
-- This changes the subscription model back from user-based to domain-based
-- Each domain/site has its own subscription

-- Step 1: Add siteId column back to subscriptions (nullable for now)
...
-- Step 3: Migrate existing subscriptions from users to sites
